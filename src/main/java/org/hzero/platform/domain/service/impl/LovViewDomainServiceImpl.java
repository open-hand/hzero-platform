...
public class LovViewDomainServiceImpl implements LovViewDomainService {
    ...
    private LovViewVO queryLovViewInfoFromDb(String viewCode, Long tenantId, String lang) {
        LovViewHeader lovViewHeader = this.lovViewHeaderRepository.selectByViewCode(viewCode, tenantId);
        ...
        //数据库数据命中,检查权限
        // 有权访问,组织缓存
        LovViewVO lovView = this.lovViewHeaderRepository.queryLovViewDTOByLovViewHeader(lovViewHeader);

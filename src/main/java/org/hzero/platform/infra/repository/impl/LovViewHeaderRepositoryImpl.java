...
public class LovViewHeaderRepositoryImpl extends BaseRepositoryImpl<LovViewHeader> implements LovViewHeaderRepository {
    ...
    @Override
    public LovViewVO queryLovViewDTOByLovViewHeader(LovViewHeader lovViewHeader) {
        ...
        LovViewLine lineQueryParam = new LovViewLine();
        lineQueryParam.setViewHeaderId(lovViewHeader.getViewHeaderId());
        lineQueryParam.setEnabledFlag(BaseConstants.Flag.YES);
        List<LovViewLine> lines = this.lovViewLineRepository.select(lineQueryParam);
